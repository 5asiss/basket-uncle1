...
## 6. "0.0.0.0에서 열린 HTTP 포트가 감지되지 않았습니다" 해결

호스팅 대시보드(Render, basam.co.kr 등)에서 **시작 명령·PORT·대기 시간**을 맞춰야 합니다.  
→ **[HOSTING_DASHBOARD.md](HOSTING_DASHBOARD.md)** 에 복사해서 넣을 값과 체크리스트가 정리되어 있으니, 대시보드 설정 후 재배포하세요.
